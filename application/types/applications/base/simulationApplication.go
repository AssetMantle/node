...
type SimulationApplication struct {
	*baseapp.BaseApp
	...
	memoryKeys    map[string]*storeTypes.MemoryStoreKey
...
func (app *SimulationApplication) GetKey(storeKey string) *storeTypes.KVStoreKey {
	return app.keys[storeKey]
}

func (app *SimulationApplication) GetTKey(storeKey string) *storeTypes.TransientStoreKey {
	return app.transientKeys[storeKey]
}

func (app *SimulationApplication) GetMemKey(storeKey string) *storeTypes.MemoryStoreKey {
