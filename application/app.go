...
import (
	...
	ante2 "github.com/AssetMantle/node/ante"
)
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".AssetMantle")
}
...
func NewGaiaApp(
	...
	bApp := baseapp.NewBaseApp("GaiaApp", logger, db, encodingConfig.TxConfig.TxDecoder(), baseAppOptions...)
	...
	anteHandler, err := ante2.NewAnteHandler(
		ante2.HandlerOptions{
			...
			BypassMinFeeMsgTypes: cast.ToStringSlice(appOpts.Get("bypass-min-fee-msg-types")),
		},
	)
	if err != nil {
